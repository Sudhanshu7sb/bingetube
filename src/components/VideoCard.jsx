                ...
                <div className="flex text-white mt-3">
                    <div className="flex items-start">
                        <div className="flex h-9 w-9 rounded-full overflow-hidden">
                            <img src={video?.author?.avatar[0].url} alt="author" className='h-full w-full object-cover' />
                        </div>
                    </div>
                    <div className='flex flex-col ml-3 overflow-hidden'>
                        ...
                        <div className="text-[12px] flex font-semibold text-white/[0.7] truncate overflow-hidden">
